/**
 * Client-side Sync component
 * Handles data synchronization from Asana to Supabase
 */
...
export function SyncClient({ lastSync, userEmail }: SyncClientProps) {
  ...
  const formatLastSync = (timestamp: string) => {
    ...
    return {
      ...
      absolute: date.format('MMMM DD, YYYY at HH:mm:ss'),
    };
  };
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Sync data from Asana to the dashboard database
              </p>
            </div>
          ...
          <CardContent>
            {currentSync ? (
              <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="font-medium">
                        Last Sync: {formatLastSync(currentSync.lastUpdated).relative}
                      </div>
                      <div className="text-sm text-gray-500">
                        {formatLastSync(currentSync.lastUpdated).absolute}
                      </div>
                    </div>
                  </div>
                ...
                {currentSync.recordCount && (
                  <div className="text-sm text-gray-600">
                    Records processed: {currentSync.recordCount.toLocaleString()}
                  </div>
                )}
              </div>
            ) : (
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Fetch all data from Asana and update the database
                  </p>
                </div>
                <Button
                  onClick={handleSync}
