...
const WeeklySummaryChart = dynamic(() => import("@/components/WeeklySummaryChart"), { ssr: false });
const CurrentTasksTable = dynamic(() => import("@/components/CurrentTasksTable"), { ssr: false });
